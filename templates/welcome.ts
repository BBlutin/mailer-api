              ...
              <tbody>
                <tr>
                  <td class="column alt" style="background-color: #eeeeee; padding: 14px; text-align: center;">
                    ...
                    <p style="margin: 0; margin-bottom: 10px; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 24px; color: #333333; font-weight: 300;">Pour accéder à l'application vous pouvez utiliser <a href="${appUrl}" style="text-decoration: underline; color: #1467ac;">ce lien</a>.</p>
